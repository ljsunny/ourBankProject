...
public class NewsBoard_Bean {
	...
	private int step;
	private int depth;
	private String news_case;
	

	
	
	public String getNews_case() {
		return news_case;
	}
	public void setNews_case(String news_case) {
		this.news_case = news_case;
	}
	...
	public String toString() {
		return "NewsBoard_Bean [idx=" + idx + ", id=" + id + ", subject=" + subject + ", content=" + content
