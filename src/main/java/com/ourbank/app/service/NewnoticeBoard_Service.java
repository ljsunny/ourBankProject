...
public class NewnoticeBoard_Service {
	...
	//회원가입 arraylist
	public ArrayList<NewnoticeBoard_Bean> getSignUpList(int nStartPage, int list_num){
	...
	//예적금 arraylist
	public ArrayList<NewnoticeBoard_Bean> getSavingsList(int nStartPage, int list_num){
