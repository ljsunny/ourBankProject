...
import com.ourbank.app.mapper.IntroductionBoard_Mapper;

@Component
public class IntroductionBoard_Service {
	@Autowired
	private IntroductionBoard_Mapper boardMapper;
	
	//글입력 처리
	public void insertBoard(IntroductionBoard_Bean boardBean) {
	...
	public ArrayList<IntroductionBoard_Bean> getList(int nStartPage, int list_num){
	...
	//회원가입 arraylist
	public ArrayList<IntroductionBoard_Bean> getSignUpList(int nStartPage, int list_num){
	...
	//예적금 arraylist
	public ArrayList<IntroductionBoard_Bean> getSavingsList(int nStartPage, int list_num){
	...
	//기타 arraylist
	public ArrayList<IntroductionBoard_Bean> getEtcList(int nStartPage, int list_num){
		return this.boardMapper.getEtcList(nStartPage, list_num);
	}
	
	//글보기에 뿌릴 bean
	public IntroductionBoard_Bean getSpecificRow(int idx) {
	...
	//글 수정하기
	public void updateBoard(IntroductionBoard_Bean boardBean) {
	...
	//검색하기 => ArrayList 로 목록 
	public ArrayList<IntroductionBoard_Bean> getSearchedList(int nStartPage, int list_num, String strSearchThis){
