...
import com.ourbank.app.mapper.MeetBoard_Mapper;

@Component
public class MeetBoard_Service {
	@Autowired
	private MeetBoard_Mapper boardMapper;
	
	//글입력 처리
	public void insertBoard(MeetBoard_Bean boardBean) {
	...
	public ArrayList<MeetBoard_Bean> getList(int nStartPage, int list_num){
	...
	//회원가입 arraylist
	public ArrayList<MeetBoard_Bean> getSignUpList(int nStartPage, int list_num){
	...
	//예적금 arraylist
	public ArrayList<MeetBoard_Bean> getSavingsList(int nStartPage, int list_num){
	...
	//기타 arraylist
	public ArrayList<MeetBoard_Bean> getEtcList(int nStartPage, int list_num){
		return this.boardMapper.getEtcList(nStartPage, list_num);
	}
	
	//글보기에 뿌릴 bean
	public MeetBoard_Bean getSpecificRow(int idx) {
	...
	//글 수정하기
	public void updateBoard(MeetBoard_Bean boardBean) {
	...
	//검색하기 => ArrayList 로 목록 
	public ArrayList<MeetBoard_Bean> getSearchedList(int nStartPage, int list_num, String strSearchThis){
