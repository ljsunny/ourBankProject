...
import com.ourbank.app.service.MeetingBoard_Service;

@Controller
public class MeetingBoard_Controller {
	
	@Autowired
	MeetingBoard_Service boardService;
	...
	//답글
	@RequestMapping(value = "/meeting_show_rewrite_form.do", method = RequestMethod.GET)
	public String meeting_show_rewrite_from(
			@RequestParam("idx_num") String idx_num,
			@RequestParam("current_page") String current_page, 
			Model model) {
		logger.info("meeting_how_rewrite_form called!!");
		
		MeetingBoard_Bean boardBean=boardService.stairBoard(Integer.parseInt(idx_num));
	...
	public String meeting_viewWork(@RequestParam("idx_num") int idx_num,
		...
		MeetingBoard_Bean boardData=boardService.getSpecificRow(idx_num);
	...
	//파일 다운로드
	@RequestMapping(value = "/meeting_download.do", method=RequestMethod.GET)
	@ResponseBody
	public byte[] meeting_downProcess(HttpServletResponse response, @RequestParam String filename) 
			   throws IOException{
	...
	//글 삭제
	@RequestMapping(value="/meeting_DeleteSpecificRow.do", method=RequestMethod.GET)
	public String deleteSpecificRow(@RequestParam("idx_num") int idx_num,
									@RequestParam("current_page") int current_page,
									Model model) {
		logger.info("meeting_DeleteSpecificRow called!!");
		logger.info("idx_num=["+idx_num+"]  current_page=["+current_page+"]");
