...
<table cellspacing="1" width="700" border="1">
	...
	<c:forEach var="board" items="${searchedList}">
		<tr>
			...
			<td width="320">
				<p align="center">
				<a href="debate_viewWork.do?idx_num=${board.getIdx_num()}&current_page=${pageForView}&searchStr=${searchStr}" 
...
<table cellspacing="1" width="700" border="1">
	<tr>
		...
		<c:forEach var="i" begin="1" end="${t_pages}">
			<a href="debate_listSearchedSpecificPageWork.do?
...
<table width="700">
	<tr>
		...
		onclick="window.location='debate_listSpecificPageWork.do?current_page=1'"></td>
