...
<title>토론방게시판 글쓰기</title>

<style type="text/css">
 

</style>
<c:url var="insertUrl" value="/debate_DoWriteBoard.do" />
</head>
...
<sf:form modelAttribute="boardBean" commandName="boardBean" id="form" 
	...
	<table id="tt" width="400" border="1" cellspacing="0" cellpadding="5">
		<tr>
			<th><b>제 목</b></th>
			<td size="150"><c:if test="${re_idx==0}">
				<sf:input path="subject" size="80" maxlength="50" id="subject"/>
				</c:if>
				<c:if test="${re_idx==1}">
