	...
	<tr>
		<td>
				<div style="float: left; width: 40%; padding:10px;" >
					...
					<button type="button" onclick="javascript:review_depositlist()">예금리뷰</button>
					<button type="button" onclick="javascript:review_savingslist()">적금리뷰</button>
					<button type="button" onclick="javascript:review_etclist()">기타리뷰</button>
				</div>
				<div style="float: right; width: 50%; vertical-align: center">
					<form name=searchf method=post action="reviewSearch.do">
	...
	<c:forEach var="board" items="${boardList}">
		<tr>
			...
			<td width="320">
				<p align="center">
					<a
						href="reviewView.do?idx=${board.getIdx()}
