...
function boardlist(){
	var s="<%=searchString%>";
	if(s=="None")
		location.href='meeting_listSpecificPageWork.do?current_page=${current_page}';
	else
		location.href='meeting_listSearchedSpecificPageWork.do?pageForView=${current_page}&searchStr=${searchStr}';	
}

function boardmodify(){
	location.href='meeting_listSpecificPageWork_to_update.do?idx_num=${idx_num}&current_page=${current_page}';
}
