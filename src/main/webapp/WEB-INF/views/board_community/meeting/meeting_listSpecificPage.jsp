...
<tr>
<td>
	<form name=searchf method=post action="meeting_searchWithSubject.do" id="searchf">
		<p align="right">
	...
	<c:forEach var="board" items="${boardList}">
		<tr>
			...
			<td width="320">
				<p align="center">
					<a
						href="meeting_viewWork.do?idx_num=${board.getIdx_num()}
...
<table cellspacing="1" width="700" border="1">
	<tr>
		<td><c:forEach var="i" begin="1" end="${t_pages}">
				<a href="meeting_listSpecificPageWork.do?current_page=${i}"> [ <c:if
						test="${i==c_page}">
						<b>
...
<table width="700">
	<tr>
		<td><input type="button" value="글쓰기"
			onclick="window.location='meeting_show_write_fome.do'"></td>
