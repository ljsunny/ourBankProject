...
function boardlist(){
	var s="<%=searchString%>";
	if(s=="None")
		location.href='investList.do?current_page=${current_page}';
	else
		location.href='investSearchedList.do?pageForView=${current_page}&searchStr=${searchStr}';	
}

function boardmodify(){
	location.href='invest_show_update_form.do?idx=${idx}&current_page=${current_page}';
}
...
function download(){
	...
	location.href='invest_download.do?filename='+en_filename;
}
