...
function boardlist(){
	var s="<%=searchString%>";
	if(s=="None")
		location.href='free_listSpecificPageWork.do?current_page=${current_page}';
	else
		location.href='free_listSearchedSpecificPageWork.do?pageForView=${current_page}&searchStr=${searchStr}';	
}

function boardmodify(){
	location.href='free_listSpecificPageWork_to_update.do?idx_num=${idx_num}&current_page=${current_page}';
}
