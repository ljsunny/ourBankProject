...
function boardlist(){
	var s="<%=searchString%>";
		location.href='fullboardSearchList.do?pageForView=${current_page}&searchStr=${searchStr}';	
}

function download(){
	var param="<%=filename%>";
	en_filename=encodeURI(param)
	location.href="fullboard_download.do?filename="+en_filename;
}
</script>
